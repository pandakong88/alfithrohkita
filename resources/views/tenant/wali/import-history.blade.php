...
<div class="page-inner">
    <div class="page-header d-flex justify-content-between align-items-center mb-4">
        <div>
            <h3 class="fw-bold mb-1">Riwayat Import Wali</h3>
            <p class="text-muted small mb-0">Kelola dan pantau status batch import data wali.</p>
        </div>
        <a href="{{ route('tenant.wali.import') }}" class="btn btn-primary btn-round">
                    ...
                    <tbody style="font-size: 0.875rem;">
                        ...
                        <tr>
                            ...
                            <td class="text-center">
                                <a href="{{ route('tenant.wali.import.preview.show', $batch->id) }}"
