    ...
    <div class="page-inner py-5">
        ...
        <div class="max-w-4xl mx-auto">
            ...
            <div class="text-center mb-5">
                <h1 class="fw-bold text-dark mb-2" style="letter-spacing: -0.02em; font-size: 2.25rem;">Import Master Data Wali</h1>
                <p class="text-muted text-lg">Unggah file Excel untuk memperbarui database wali secara massal.</p>
            </div>
            ...
            <div class="card card-round border-0 shadow-sm overflow-hidden mb-4 bg-primary-gradient-premium">
                <div class="card-body p-4 position-relative">
                    <div class="d-flex align-items-center justify-content-between position-relative" style="z-index: 2;">
                        ...
                        <a href="{{ route('tenant.wali.template.download') }}" class="btn btn-white btn-round px-4 py-2 fw-bold text-primary shadow-sm hover-push">
            ...
            <div class="card card-round border-0 shadow-lg mb-4">
                <div class="card-body p-5">
                    <form method="POST" action="{{ route('tenant.wali.import.preview') }}" enctype="multipart/form-data" id="importForm">
                        @csrf
                ...
                <div class="card-body p-0">
                    <div class="table-responsive">
                        <table class="table table-hover mb-0 align-middle">
                            ...
                            <tbody>
                                <tr>
                                    <td class="ps-4 py-3 font-monospace text-primary fw-bold">nama</td>
                                    <td><span class="badge badge-success-light text-success fw-bold px-3">YA</span></td>
                                    <td class="pe-4 text-dark small">Nama lengkap wali</td>
                                </tr>
                                <tr>
                                    <td class="ps-4 py-3 font-monospace text-primary fw-bold">nik</td>
                                    <td><span class="badge badge-light-dark text-muted fw-bold px-3">OPSIONAL</span></td>
                                    <td class="pe-4 text-dark small">Nomor Induk Kependudukan (Unik)</td>
                                </tr>
                                <tr>
                                    <td class="ps-4 py-3 font-monospace text-primary fw-bold">no_hp</td>
                                    <td><span class="badge badge-light-dark text-muted fw-bold px-3">OPSIONAL</span></td>
                                    <td class="pe-4 text-dark small">Nomor HP/WhatsApp wali (Unik)</td>
                                </tr>
                                <tr>
                                    <td class="ps-4 py-3 font-monospace text-primary fw-bold">alamat</td>
                                    <td><span class="badge badge-light-dark text-muted fw-bold px-3">OPSIONAL</span></td>
                                    <td class="pe-4 text-dark small">Alamat lengkap wali</td>
                                </tr>
                                <tr>
                                    <td class="ps-4 py-3 font-monospace text-primary fw-bold">pekerjaan</td>
                                    <td><span class="badge badge-light-dark text-muted fw-bold px-3">OPSIONAL</span></td>
                                    <td class="pe-4 text-dark small">Pekerjaan wali</td>
                                </tr>
                            </tbody>
                        </table>
                    </div>
