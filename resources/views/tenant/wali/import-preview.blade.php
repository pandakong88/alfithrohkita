...
@section('title', 'Preview Import Wali')
    ...
    <div class="page-inner py-5">
        ...
        <div class="max-w-7xl mx-auto">
            ...
            <div class="d-flex align-items-left align-items-md-center flex-column flex-md-row mb-4">
                <div>
                    <h2 class="text-dark fw-bold mb-1">Pratinjau Import Data Wali</h2>
                    <h6 class="text-muted mb-0">Silakan periksa kembali data Anda sebelum disimpan secara permanen.</h6>
                </div>
                <div class="ms-md-auto py-2 py-md-0">
                    <a href="{{ route('tenant.wali.import') }}" class="btn btn-label-danger btn-round me-2">
                        <i class="fas fa-undo me-1"></i> Batalkan
                    </a>
                    @if($batch->status == 'preview' && $batch->invalid_rows == 0)
                        <form method="POST" action="{{ route('tenant.wali.import.commit', $batch->id) }}" class="d-inline">
                            @csrf
                        ...
                        <table class="table table-hover table-head-bg-light mb-0 align-middle">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <div class="fw-bold text-dark">{{ $payload['nama'] ?? '-' }}</div>
                                    </td>
                                    <td><code class="text-primary fw-bold">{{ $payload['nik'] ?? '-' }}</code></td>
                                    <td><span class="text-muted small">{{ $payload['no_hp'] ?? '-' }}</span></td>
                                    <td><span class="text-muted small">{{ $payload['pekerjaan'] ?? '-' }}</span></td>
                ...
                <div class="card-footer bg-white border-top py-4">
                    <div class="d-flex flex-column flex-md-row align-items-center justify-content-between">
                        ...
                        <div class="text-muted small mb-3 mb-md-0">
                            ...
                            dari <span class="fw-bold text-dark">{{ $rows->total() }}</span> data wali
                        </div>
...
<style>
    ...
    .max-w-7xl { max-width: 1250px; margin: auto; }
