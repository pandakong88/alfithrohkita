...
<div class="page-inner">
    ...
    <div class="page-header">
        <h4 class="page-title">Konfigurasi Template PDF</h4>
                ...
                <div class="card-body p-5 text-center">
                    <form method="POST" action="{{ route('tenant.template-perizinan.upload.store') }}" enctype="multipart/form-data">
                        ...
                        <div class="upload-drop-zone p-5 border-2 border-dashed rounded-3 mb-0"
                             ...
                             style="cursor: pointer; border-color: #ebedf2; border-style: dashed;">
    ...
    <div class="row">
        ...
        <div class="col-lg-7">
            <div class="card card-round">
                <div class="card-header d-flex justify-content-between align-items-center bg-white border-bottom-0">
                    <div class="card-title fw-bold text-dark"><i class="fas fa-file-pdf text-danger me-2"></i>Penempatan Data Tag (Drag & Drop)</div>
                    <span class="badge badge-success">PDF Siap</span>
                </div>
                <div class="card-body bg-light p-3 text-center" style="overflow-x: auto;">
                    ...
                    <div id="pdf-wrapper" style="position: relative; display: inline-block; box-shadow: 0 10px 30px rgba(0,0,0,0.15); border-radius: 8px; overflow: hidden; background: white;">
                        ...
                        <div id="pdf-overlay" style="position: absolute; top: 0; left: 0; width: 100%; height: 100%; pointer-events: auto; z-index: 10;">
                            {{-- Element drag variables akan dimasukkan di sini oleh JS --}}
                        </div>
                    </div>
                </div>
            </div>
        ...
        <div class="col-lg-5">
            <div class="card card-round">
                <form method="POST" action="{{ route('tenant.template-perizinan.store') }}" id="template-form">
                    @csrf
                    ...
                    <div class="card-body">
                        ...
                        <div class="form-group p-0 mb-3">
                            ...
                            <input type="text" name="nama" class="form-control" placeholder="Contoh: Surat Izin Pulang Resmi" required>
                        </div>
                        ...
                        <div class="bg-light p-3 rounded-3 mb-4 border">
                            <div class="custom-control custom-checkbox mb-2">
                                <input type="checkbox" class="custom-control-input" id="rule_late_penalty_enabled" name="rules[late_penalty][enabled]" value="1">
                            ...
                            <div class="row g-2 mt-2" id="late-penalty-settings" style="display: none;">
                                <div class="col-6">
                                    <label class="small text-muted fw-bold">Setiap Terlambat (Menit)</label>
                                    <input type="number" name="rules[late_penalty][interval_minutes]" class="form-control form-control-sm" value="60">
                                </div>
                                <div class="col-6">
                                    <label class="small text-muted fw-bold">Denda Poin Pelanggaran</label>
                                    <input type="number" name="rules[late_penalty][points_per_interval]" class="form-control form-control-sm" value="5">
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="card-footer bg-transparent border-0 px-4 pb-4">
                        <div class="d-grid gap-2">
                            ...
                            <a href="{{ route('tenant.template-perizinan.index') }}" class="btn btn-link text-danger fw-bold mt-1">
...
<script>
    ...
    $(document).ready(function() {
        ...
        // COORDINATE MAPPER drag-and-drop
        ...
        function spawnPlacedVariable(key, label, pctX, pctY) {
            ...
            // Tambahkan hidden input koordinat ke form
            const inputHtml = `
            ...
            updateCoordPercent(badge);
        }

        // Hapus variable yang terpasang
        ...
        function updateCoordPercent(el) {
            const container = $(overlay);
            const left = el.offsetLeft;
            const top = el.offsetTop;
            
            const pctX = (left / container.width()) * 100;
            const pctY = (top / container.height()) * 100;

            const key = $(el).data('key').replace('.', '_');
            $(`#coord-x-${key}`).val(pctX.toFixed(2));
            $(`#coord-y-${key}`).val(pctY.toFixed(2));
        }

        // Vanilla Drag-and-Drop Handler
