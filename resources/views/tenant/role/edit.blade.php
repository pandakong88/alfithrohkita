...
<div class="container-fluid px-0">
    <div class="d-flex justify-content-between align-items-center mb-4 flex-wrap gap-3">
        <div>
            <h3 class="fw-bold mb-1 text-dark">Edit Role: {{ format_role_name($role->name) }}</h3>
    ...
    <form method="POST" action="{{ route('tenant.role.update', $role) }}">
        ...
        <div class="row">
            <div class="col-lg-4">
                <div class="card border-0 shadow-sm mb-4 card-custom card-accent-warning">
                    ...
                    <div class="card-body pt-0">
                        <div class="mb-3">
                            ...
                            <small class="text-warning fw-semibold mt-2 d-block small">
                        ...
                        <a href="{{ route('tenant.role.index') }}" class="btn btn-link btn-sm w-100 mt-2 text-muted text-decoration-none">Batal</a>
                    </div>
                </div>
            </div>
            ...
            <div class="col-lg-8">
                <div class="card border-0 shadow-sm card-custom">
                    <div class="card-header bg-white py-3 d-flex justify-content-between align-items-center border-0">
                        <h5 class="card-title mb-0 fw-bold text-dark">Sesuaikan Permissions</h5>
                                                            ...
                                                            <div class="permission-card border rounded p-3 h-100 transition-all shadow-xs">
                                                                <div class="custom-checkbox d-flex align-items-start">
                                                                    <input type="checkbox" 
                                                                           ...
                                                                           {{ in_array($permName, old('permissions', $role->permissions->pluck('name')->toArray())) ? 'checked' : '' }}>
